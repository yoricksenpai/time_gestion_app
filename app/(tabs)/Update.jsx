...
import { Platform, SafeAreaView, Text, TextInput, TouchableOpacity, View, Alert } from 'react-native';
    ...
    useEffect(() => {
        const fetchActivity = async () => {
            try {
                ...
                setNature(activity.nature);
                if (activity.reminderTime) {
                    const reminderDateTime = new Date(activity.reminderTime);
                ...
                setAllDay(activity.allDay || false);
            } catch (error) {
                console.error('Error fetching activity:', error);
                showNotification('Failed to fetch activity details. Please try again.', 'error');
            }
        };
        fetchActivity();
    }, [id]);
                ...
                { 
                    ...
                    onPress: async () => {
                        try {
                            ...
                            showNotification('Failed to update activity. Please try again.', 'error');
                        }
                    }
                }
            ]
    ...
    return (
        <SafeAreaView className="flex-1 bg-gray-50">
            ...
            >
                ...
                >
                    <Text className="text-3xl font-poppinsBold mb-6 text-blue-600 p-10 text-center">Update Activity</Text>
                </LinearGradient>
